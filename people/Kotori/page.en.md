...
and avatar of that account was also the character `∂`, which was a stylized cursive d mainly used as a mathematical symbol, usually to denote a partial derivative such as `\frac{∂z}{∂x}`.
